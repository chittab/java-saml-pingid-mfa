...
public class AuthRequest {
    ...
    public String getRequest(int format) throws XMLStreamException, IOException {
        ...
        writer.writeAttribute("ProviderName", "https://sungardas.microland.com/sso/saml2update1/2017/v1/");
        writer.writeAttribute("Destination", "https://uat-sso.sungardas.com/service/saml2/idp");
